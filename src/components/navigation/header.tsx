    ...
    <header className="w-full h-20 bg-[var(--background)] border-b border-[var(--card-border)] fixed top-0 left-0 z-50">
      <div className="flex justify-between items-center h-full px-4 sm:px-8 lg:px-48">
        ...
        <nav className="hidden md:flex gap-10 items-center">
          ...
          <Link
            href="/login"
            className="rounded-lg flex items-center justify-center gap-3 px-6 py-3 text-[var(--accent)] bg-[var(--background)] border-2 border-[var(--accent)] cursor-pointer hover:bg-[var(--accent)] hover:text-[var(--background)] transition-all duration-300 font-medium"
          >
            <Calendar size={20} />
            <span>Agendar</span>
          </Link>
        ...
        {/* Mobile - Botão Agendar + Menu Hamburguer */}
